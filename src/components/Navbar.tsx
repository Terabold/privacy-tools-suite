      ...
      <div className="container mx-auto flex h-full items-center justify-between px-4 lg:px-8 gap-4 md:gap-12">
          ...
          <div className="hidden md:flex flex-col grow max-w-2xl gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
             <div className="relative group">
                ...
                <Input
                  ...
                  className="h-9 pl-11 pr-10 text-sm font-medium bg-zinc-950/40 border-primary/5 rounded-xl focus-visible:ring-primary/20 focus-visible:border-primary/20 transition-all placeholder:text-muted-foreground/30 shadow-inner"
                />
                {searchQuery && (
                  <button
             ...
             <div className="flex flex-wrap items-center gap-2 justify-center">
                <button
                  ...
                  className={`px-5 py-2 rounded-lg font-black uppercase tracking-widest text-[10px] transition-all duration-300 flex items-center gap-2 border border-transparent ${
        ...
        <div className="flex items-center gap-2 md:gap-4 shrink-0 md:min-w-[100px] justify-end">
          <Button 
            ...
            className="rounded-xl hover:bg-primary/10 transition-colors h-10 w-10 md:h-14 md:w-14 border border-transparent hover:border-primary/10"
          >
        ...
        <div className="md:hidden px-4 pb-4 animate-in slide-in-from-top-2 duration-300">
          <div className="relative">
            ...
            <Input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery?.(e.target.value)}
              className="h-8 pl-9 pr-8 text-xs bg-zinc-950/40 border-primary/5 rounded-lg focus-visible:ring-primary/10"
            />
          </div>
        </div>
      )}
