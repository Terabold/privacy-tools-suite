            ...
            <div className="lg:col-span-8 space-y-8">
              {!file ? (
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-300">
                  <Card className="glass-morphism border-primary/10 rounded-[32px] overflow-hidden bg-black shadow-2xl relative border border-border/50 max-w-2xl w-full mx-auto">
                    <video 
                      ref={videoRef}
                      src={videoUrl!}
                      onLoadedMetadata={(e) => {
                 ...
                 <div className="bg-primary/5 p-5 border-b border-primary/10 flex items-center justify-between">
                   ...
                   {file && (
                     <Button 
                       ...
                       variant="ghost" 
                       size="sm" 
                       className="h-8 px-3 text-[9px] font-bold uppercase tracking-widest text-destructive hover:bg-destructive/10 border border-destructive/10 rounded-xl transition-all"
                     >
                       Reset
                     </Button>
                   )}
